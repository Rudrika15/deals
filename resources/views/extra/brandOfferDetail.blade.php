                        ...
                        @if ($offers->count() != 0)
                            <div class="row pt-2 my-3 px-4">
                                @foreach ($offers as $brandWithCategory)
                                    <div class="col-md-4">
                                        <a
                                            href="{{ route('brand.detail') }}/{{ $brandWithCategory->brand->id }}/{{ request('categoryId') }}">
                                            <div class="card ">
                                                <div class="d-inline-block position-relative">

                                                    <img class="card-img-top"
                                                        src="{{ asset('cardlogo') }}/{{ $brandWithCategory->brand->card->logo ?? '-' }}"
                                                ...
                                                <div class="card-body">
                                                    <h4 class="card-title">
                                                        {{ $brandWithCategory->brand->card->name ?? '-' }}</h4>
                                                    <p class="card-text">
